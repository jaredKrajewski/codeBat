...
function makeLast(a) {
    ...
    let double = a.concat(a);
    let result = [];
  
    double.forEach((num) => result.push(num - num));
    result.pop();
    return result.concat(lastNum);
  }
...
/*
Goal:take two arrays and compare their sums. return the array with the larger sum. if a tie return a
Params: array1: a, array2: b;
Return Val: array
Logic:
...
/*
Goal: take an even length array and return a new 2 length array containing the middle two elements of the original;
Params: array: a;
Return Val: array
Logic: 
...
/*
Goal:take an array and return a new array length of 3 with the elements from the middle of the original array;
Params: array: a;
Return Val: array
Logic:
...
/*
Goal: take an array and return a new array of its first 2. if array is less than 2 use whatever is present 
Params:array: a;
Return Val: array
Logic: 
...
/* 
Goal: if a 1 is followed by a 3 in the first 2 or last 2 positions return true otherwise return false
Params: array: a
Return Val: boolean
Logic:
...
/* 
Goal: take 2 arrays and return array with first element of each array. if an array is empty ignore it.
Params: array1: a, array2: b;
Return Val: array
Logic:
